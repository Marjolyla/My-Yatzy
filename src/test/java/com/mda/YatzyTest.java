...
public class YatzyTest {
    ...
    @Test
    public void given_1_2_3_4_5_when_ones_then_return_sum_all_ones_1(){
    ...
    @Test
    public void given_1_2_1_4_1_when_ones_then_return_sum_all_ones_3(){
    ...
    @Test
    public void given_none_1_when_ones_then_return_0(){
    ...
    @Test
    public void given_1_2_3_4_5_when_twos_then_return_sum_all_twos_2(){
        Yatzy game = Yatzy.of(1,2,3,4,5);
    ...
    @Test
    public void given_1_2_2_2_1_when_twos_then_return_sum_all_twos_6(){
    ...
    @Test
    public void given_none_2_when_twos_then_return_0(){
    ...
    @Test
    public void given_1_2_3_4_5_when_threes_then_return_sum_all_threes_3(){
        Yatzy game = Yatzy.of(1,2,3,4,5);
    ...
    @Test
    public void given_1_3_3_3_1_when_threes_then_return_sum_all_threes_9(){
    ...
    @Test
    public void given_none_3_when_threes_then_return_0(){
    ...
    @Test
    public void given_1_2_3_4_5_when_fours_then_return_sum_all_fours_4(){
        Yatzy game = Yatzy.of(1,2,3,4,5);
    ...
    @Test
    public void given_1_3_3_4_4_when_fours_then_return_sum_all_fours_8(){
    ...
    @Test
    public void given_none_8_when_fours_then_return_0(){
    ...
    @Test
    public void given_1_2_3_4_5_when_fives_then_return_sum_all_fives_5(){
        Yatzy game = Yatzy.of(1,2,3,4,5);
    ...
    @Test
    public void given_5_5_3_4_4_when_fives_then_return_sum_all_fives_10(){
    ...
    @Test
    public void given_none_5_when_fives_then_return_0(){
    ...
    @Test
    public void given_1_2_3_4_6_when_sixes_then_return_sum_all_sixes_6(){
    ...
    @Test
    public void given_1_3_6_6_6_when_sixes_then_return_sum_all_sixes_18(){
    ...
    @Test
    public void given_none_6_when_sixes_then_return_0(){
        Yatzy game = Yatzy.of(1,1,2,3,5);
        int result = game.sixes();
        int expected = 0;
        assertEquals(expected, result, "The result should be 0");
    ...
    public void given_value_smaller_than_1_when_of_then_throws_an_exception(){
        ...
        String expectedMsg = String.format(Yatzy.ILLEGAL_ARGUMENT_MSG_ERROR, 1, 0, 3, 4, 5);
    ...
    public void given_value_larger_than_6_when_of_then_throws_an_exception(){
        ...
        String expectedMsg = String.format(Yatzy.ILLEGAL_ARGUMENT_MSG_ERROR, 1, 1, 31, 4, 5);
        assertEquals(expectedMsg, exception.getMessage());
    }
